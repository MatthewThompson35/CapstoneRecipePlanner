...
INSERT INTO `ingredient` VALUES (1,'admin',8),(1,'global',5),(2,'global',20),(3,'admin',49),(3,'global',27),(4,'admin',27),(4,'global',56),(9,'global',102),(10,'global',7),(11,'admin',4),(55,'global',32323);
...
INSERT INTO `login` VALUES ('admin','202cb962ac59075b964b07152d234b70'),('destiny','21232f297a57a5a743894a0e4a801fc3'),('global','ee11cbb19052e40b07aac0ca060c23ee'),('newUser','14a88b9d2f52c55b5fbcf9c5d9c11875'),('testuser1','asd'),('testuser2','asd'),('user','c20ad4d76fe97759aa27a0c99bff6710');
...
INSERT INTO `planned_recipe` VALUES (1,'Monday','Breakfast','2023-04-03','global'),(1,'Monday','Dinner','2023-04-03','global'),(1,'Tuesday','Lunch','2023-04-11','global'),(2,'Tuesday','Breakfast','2023-04-04','admin'),(2,'Tuesday','Dinner','2023-04-04','admin'),(2,'Monday','Lunch','2023-04-03','global'),(2,'Tuesday','Lunch','2023-04-04','admin'),(3,'Friday','Lunch','2023-03-24','global'),(3,'Monday','Lunch','2023-04-10','global');
...
INSERT INTO `recipe` VALUES (1,'Scrambled Eggs','Two scrambled eggs w/ cheese'),(2,'Bowl of Lucky Charms','A bowl of delicious Lucky Charms and milk'),(3,'Ham and Cheese Sandwich','A simple sandwich for on-the-go'),(4,'cheese toast','cheese with toast'),(5,'aaaaa','aaaaa'),(6,'test','test'),(7,'addRecipe','add'),(8,'asd','asdasd');
...
INSERT INTO `recipe_ingredient` VALUES (1,1,1,'COUNT'),(1,2,2,'COUNT'),(2,3,20,'G'),(2,4,4,'OZ'),(3,1,1,'COUNT'),(3,17,2,'COUNT'),(3,18,1,'COUNT'),(4,1,8,'COUNT'),(4,56,1,'COUNT'),(5,50,12,'COUNT'),(6,50,1,'COUNT'),(7,57,1,'COUNT'),(8,57,23,'COUNT');
...
INSERT INTO `recipe_tag` VALUES (1,'breakfast'),(1,'simple'),(1,'vegetarian'),(2,'breakfast'),(2,'simple'),(3,'lunch'),(3,'simple'),(4,'toast'),(5,'asd'),(6,'test'),(7,'add'),(8,'add');
...
INSERT INTO `shared_recipe` VALUES ('destiny','global',1),('global','admin',1),('global','global',1),('global','user',1),('global','admin',2),('global','destiny',2),('global','global',2),('global','admin',3),('global','destiny',3),('global','global',3);
...
INSERT INTO `shopping_list` VALUES (4,'global',21),(10,'global',5),(11,'global',9),(12,'global',2),(13,'global',5),(14,'global',6),(18,'global',2),(54,'global',244);
...
-- Dump completed on 2023-04-04 19:01:06
